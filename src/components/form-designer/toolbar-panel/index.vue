<template>
  <div class="toolbar-container">
    <dir class="toolbar-content">
      <div class="left-toolbar">
        <el-button
          ...
          :title="$t('designer.toolbar.undoHint')"
          @click="undoHistory"
        >
        ...
        <el-button
          ...
          :title="$t('designer.toolbar.redoHint')"
          @click="redoHistory"
        >
        ...
        <el-button
          ...
          :title="$t('designer.toolbar.nodeTreeHint')"
    ...
    >
      <el-dialog
        :title="$t('designer.toolbar.preview')"
        ...
        <template #footer>
          <div class="dialog-footer">
            <el-button type="primary" @click="getFormData">{{
              $t("designer.hint.getFormData")
            }}</el-button>
            <el-button type="primary" @click="resetForm">{{
              $t("designer.hint.resetForm")
            }}</el-button>
            <el-button type="primary" @click="setFormDisabled">{{
              $t("designer.hint.disableForm")
            }}</el-button>
            <el-button type="primary" @click="setFormEnabled">{{
              $t("designer.hint.enableForm")
            }}</el-button>
        ...
        <template #footer>
          <div class="dialog-footer">
            ...
            <el-button @click="saveVueCode">{{
              $t("designer.hint.saveVueCode")
            }}</el-button>
            <el-button @click="saveHtmlCode">{{
              $t("designer.hint.saveHtmlCode")
            }}</el-button>
    ...
    >
      <el-dialog
        :title="$t('designer.toolbar.generateSFC')"
        ...
        <template #footer>
          <div class="dialog-footer">
            ...
            <el-button @click="saveV2SFC">{{
              $t("designer.hint.saveVue2SFC")
            }}</el-button>
            <el-button @click="saveV3SFC">{{
              $t("designer.hint.saveVue3SFC")
            }}</el-button>
...
export default {
  ...
  methods: {
    ...
    saveAsFile(fileContent, defaultFileName) {
      this.$prompt(
        this.$t("designer.hint.fileNameForSave"),
        this.$t("designer.hint.saveFileTitle"),
        {
