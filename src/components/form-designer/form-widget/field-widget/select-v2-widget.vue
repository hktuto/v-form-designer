<template>
  <form-item-wrapper :designer="designer" :field="field" :rules="rules" :design-state="designState"
    ...
    <el-select-v2 ref="fieldEditor" v-model="fieldModel" class="full-width-input"
      ...
      :placeholder="field.options.placeholder ? $t(field.options.placeholder) : $t('render.hint.selectPlaceholder')"
